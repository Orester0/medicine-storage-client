...
@Component({
  ...
  imports: [MatTooltipModule, CommonModule, ReactiveFormsModule, MatIconModule, TemplateDatePickComponent, CreateTemplateFormComponent, TemplateDetailsComponent],
